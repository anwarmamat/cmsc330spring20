...
let public_test_nfa_accept ctxt =
  let m1 =
...
let public_test_nfa_to_dfa ctxt =
  let m1 =
    { qs= [0; 1; 2; 3]
    ; sigma= ['a'; 'b']
...
let public_test_nfa_closure ctxt =
  let m1 =
...
let public_test_nfa_new_states ctxt =
  let m1 =
  { qs= [0; 1; 2; 3; 4]
  ; sigma= ['a'; 'b']
...
let public_test_nfa_new_trans ctxt =
  let m1 =
  { qs= [0; 1; 2; 3; 4]
  ; sigma= ['a'; 'b']
  ; delta= [(0, Some 'a', 1); (0, Some 'a', 2); (2, Some 'b', 3); (2, None, 4); (4, Some 'a', 4)]
...
let public_test_nfa_new_finals ctxt =
  let m1 =
  { qs= [0; 1; 2; 3; 4]
  ; sigma= ['a'; 'b']
  ; delta= [(0, Some 'a', 1); (0, Some 'a', 2); (2, Some 'b', 3); (2, None, 4); (4, Some 'a', 4)]
...
let public_test_re_to_nfa ctxt =
...
let public_test_str_to_nfa ctxt =
...
let suite =
  "public"
  >::: [ "public_nfa_accept" >:: public_test_nfa_accept
       ; "public_nfa_closure" >:: public_test_nfa_closure
       ; "public_nfa_move" >:: public_test_nfa_move
       ; "public_nfa_to_dfa" >:: public_test_nfa_to_dfa
       ; "public_re_to_nfa" >:: public_test_re_to_nfa
       ; "public_str_to_nfa" >:: public_test_str_to_nfa 
       ; "public_nfa_new_states" >:: public_test_nfa_new_states
       ; "public_nfa_new_trans" >:: public_test_nfa_new_trans
       ; "public_nfa_new_finals" >:: public_test_nfa_new_finals]
